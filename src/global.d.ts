...
interface SelectSettingDescItem extends SettingItemGeneric {
	type: 'sel';
	opts?: string[];
	optLabels?: string[];
}
interface KeybindSettingDescItem extends SettingItemGeneric {
	type: 'keybind';
}
...
interface NumSettingItem extends SettingItemGeneric {
	type: 'num';
	min?: number;
	max?: number;
}
