...
function mapScopeLabel(criteria: IMatchmakerCriteria): string {
	...
	return criteria.mapScope === 'official' ? `${criteria.maps.length} official picked` : `${criteria.maps.length} picked`;
}
...
export function matchmakerSearchingView(criteria: IMatchmakerCriteria, hotkeys: MatchmakerHotkeyLabels): MatchmakerView {
	return {
...
export function matchmakerLobbyView(game: IMatchmakerGame, latencyMs: number | undefined, hotkeys: MatchmakerHotkeyLabels): MatchmakerView {
	return {
...
export function matchmakerNoGamesView(criteria: IMatchmakerCriteria, hotkeys: MatchmakerHotkeyLabels, openServerWindow: boolean): MatchmakerView {
	return {
...
export function matchmakerErrorView(message: string, hotkeys: MatchmakerHotkeyLabels, openServerWindow: boolean): MatchmakerView {
	return {
		cancel: closeAction(hotkeys, openServerWindow),
		chips: [],
		description: message,
