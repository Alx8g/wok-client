type PointerLockRequest<TThis> = (this: TThis, options?: PointerLockOptions) => unknown;
...
function isPromiseLike(value: unknown): value is PromiseLike<unknown> {
	return ((typeof value === 'object' && value !== null) || typeof value === 'function') && typeof (value as PromiseLike<unknown>).then === 'function';
}
...
export function installRawPointerLock<TThis>(target: PointerLockPrototype<TThis>, initiallyEnabled = true): RawPointerLockController {
	...
	const wrapped: MarkedPointerLockRequest<TThis> = function (this: TThis, ...originalArguments: [options?: PointerLockOptions]) {
